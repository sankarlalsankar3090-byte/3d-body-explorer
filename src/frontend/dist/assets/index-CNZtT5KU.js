  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Dna,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-base tracking-tight leading-none", children: "3D Body Explorer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs font-body mt-0.5 leading-none", children: "Interactive Human Anatomy" })
          ] })
        ] }) })
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs text-center sm:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "Educational Disclaimer:" }),
            " ",
            "यह ऐप केवल शैक्षिक उद्देश्यों के लिए है। This app is for educational purposes only. Content is not a substitute for professional medical advice."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs flex-shrink-0", children: [
            "© ",
            year,
            ".",
            " ",
...
const ExplorerPage = reactExports.lazy(
  () => __vitePreload(() => import("./ExplorerPage-BswoWpGN.js"), true ? [] : void 0).then((m) => ({ default: m.ExplorerPage }))
);
...
const indexRoute = createRoute({
  ...
  component: function IndexPage() {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-background" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExplorerPage, {}) }) });
  }
});
...
export {
  ...
  React$4 as m,
  noop$6 as n,
  useSyncExternalStoreExports as o,
